 ...
 */
// var readLine = require('readline-sync'); var userInput =
// readLine.question('Number?'); for (var i = 1; i < userInput; i++) {
// process.stdout.write(`${i},`); } process.stdout.write(userInput);
// console.log(); //ver 2 var arr = []; for (var i = 1; i <= userInput; i++) {
// arr.push(i); } console.log(arr.join('-'));
...
var list2 = [3, 4, 157, 6, 70].reduce(add, 0);
console.log(list2);
